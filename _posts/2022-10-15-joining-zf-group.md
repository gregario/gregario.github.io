...
My first week at ZF Group, I tried to push a change to the product roadmap. In a startup, that takes a conversation and a whiteboard. At ZF, it took a slide deck, three alignment meetings, a steering committee review, and a sign-off chain that included someone in Friedrichshafen whose title I still can't pronounce correctly.

I'd gone from a company where I was the CEO, CTO, and occasionally the person fixing the printer, to a company with 150,000 employees that makes transmissions for half the trucks in Europe. The culture shock was real.

## Why I did it

The honest answer: I was tired. Three years of running AutoPlan had drained me in ways I didn't fully appreciate until I stopped. I wanted a salary. I wanted to not check my bank balance every morning. I wanted someone else to worry about payroll.

The strategic answer: ZF was building a new digital products division from scratch. They wanted people who could "think like a startup" inside enterprise. I'd done a startup. I'd failed at a startup. Apparently that qualified me.

The role was Senior Product Manager for a new SaaS platform targeting commercial fleet operators. I'd be building 0-to-1 inside a company that had been building gearboxes since 1915. The irony was not lost on me.
...
I learned to translate between two languages: startup urgency and enterprise governance. "We need to ship this fast" becomes "we're proposing an accelerated timeline to capture the Q3 market window." Same energy, different vocabulary.

The trick is finding the spaces where you can move fast without triggering the antibodies. Internal tools? Ship whatever you want. Customer-facing features behind a beta flag? Surprisingly easy to get approved. Changing the pricing model? That's a board-level conversation, don't even try.

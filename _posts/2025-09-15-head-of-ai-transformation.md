...
1. Where are we now? (current AI maturity, measured quarterly)
2. Where do we want to be in 12 months? (specific, measurable targets)
3. What needs to happen to get there? (projects, resources, dependencies)
